...
image:Janis Joplin/Pearl Legacy Edition/cover.png[Pearl Legacy Edition,200,200,role="thumb left"]

.Jefferson Airplane - link:Jefferson%20Airplane%20-%20Surrealistic%20Pillow/lyrics/pillow.html#_white_rabbit[White Rabbit]
